...
ENV_CLASSES = {
    ...
    "llm_in_sandbox": safe_import("rllm.environments.llm_in_sandbox.llm_in_sandbox_env", "LLMinSandboxEnv"),
}
...
AGENT_CLASSES = {
    ...
    "llm_in_sandbox_agent": safe_import("rllm.agents.llm_in_sandbox_agent", "LLMinSandboxAgent"),
}
